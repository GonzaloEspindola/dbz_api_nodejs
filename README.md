...
<br />
<div align="center">
  <a href="https://github.com/GonzaloEspindola/dbz_api_nodejs">
...
3. Crea un archivo .env en la raiz del proyecto siguiendo el siguiente esquema.
    ```sh
      ...
      DB_PORT: '',
    ```
4. Dirigete a la raiz y ejecuta
   ```sh
    npm run dev
   ```
